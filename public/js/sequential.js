...
TflipFlop.prototype.customDraw = function() {
    ...
    // if ((this.b.hover&&!simulationArea.shiftDown)|| simulationArea.lastSelected == this || simulationArea.multipleObjectSelections.contains(this)) ctx.fillStyle = window[$('input[name=colorScheme]:checked').val()].canvas.elementHover;ctx.fill();
    ctx.stroke();
